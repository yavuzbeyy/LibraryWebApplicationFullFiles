...
namespace Katmanli.DataAccess.Migrations
{
    ...
    [Migration("20240426210207_MessageTableCreated")]
            ...
            modelBuilder.Entity("Katmanli.DataAccess.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 4, 27, 0, 2, 7, 257, DateTimeKind.Local).AddTicks(7426),
                            RoleName = "Admin"
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2024, 4, 27, 0, 2, 7, 257, DateTimeKind.Local).AddTicks(7441),
                            RoleName = "User"
                        });
                });
